...
---
## Intro
The Spotify playlist dataset contains roughly 12 million songs grouped together by the playlist they were placed into. The playlists are named by users so we'll take a look at what kind of trends we can find in these playlist names.
...
Then we'll dive a little deeper. We can use the tidytext package to match sentimental associations to the words people use to name their playlists. Figures 8 through 15 show the songs that come up most for each sentiment.

People also tend to put years into their playlist names. Figure 16 takes a look at a few songs that seemed to pop up a lot of year-themed playlists and how their popularity changed over time.
